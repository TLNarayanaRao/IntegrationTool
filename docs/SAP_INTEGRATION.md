...
```text
C:\ProgramData\MINA Studio\drivers\sap\sapjco3.jar
C:\ProgramData\MINA Studio\drivers\sap\sapjco3.dll
```
...
upstream bridge; MINA does not claim an XA transaction spanning
