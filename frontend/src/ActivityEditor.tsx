...
function InputEditor({ node, fields, mappings, set, properties, sources, customFunctions, updateCustomFunctions, before, expanded = false }: any) {
...
function TransformInputEditor({ config, properties, sources, setMappings, customFunctions, updateCustomFunctions, expanded = false }: any) {
  properties = Object.assign([...(properties || [])], { customFunctions, updateCustomFunctions });
