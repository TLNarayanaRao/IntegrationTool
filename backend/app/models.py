...
def default_environment_properties() -> list[EnvironmentProperty]:
    ...
    values = [
        ...
        ('connections.jdbc.connectionMode', 'python', 'string'),
        ('connections.jdbc.driverDirectory', '', 'string'),
        ('connections.jdbc.driverClass', '', 'string'),
        ('connections.jdbc.odbcDriver', '', 'string'),
        ('connections.jdbc.authentication', 'SQL Server Authentication', 'string'),
        ('connections.jdbc.encrypt', True, 'boolean'),
        ('connections.jdbc.trustServerCertificate', False, 'boolean'),
        ('connections.jdbc.serverHostname', '', 'string'),
        ('connections.jdbc.httpPath', '', 'string'),
        ('connections.jdbc.accessToken', '', 'password'),
        ('connections.jdbc.clientId', '', 'string'),
        ('connections.jdbc.clientSecret', '', 'password'),
        ('connections.jdbc.catalog', '', 'string'),
        ('connections.jdbc.useCloudFetch', True, 'boolean'),
        ('connections.jdbc.serviceName', '', 'string'),
        ('connections.jdbc.sid', '', 'string'),
        ('connections.jdbc.sslCaFile', '', 'string'),
        ...
        ('connections.amqp.clientId', '', 'string'),
        ...
        ('connections.ems.driverDirectory', '', 'string'),
        ('connections.ems.connectionFactoryClass', 'com.tibco.tibjms.TibjmsConnectionFactory', 'string'),
        ('connections.ems.connectionTimeoutSeconds', 30, 'integer'),
        ('connections.ems.destination', 'orders', 'string'),
        ('connections.ems.sessionCount', 1, 'integer'),
        ('connections.ems.flowLimit', 0, 'integer'),
        ('connections.ems.receiveTimeoutMs', 30000, 'integer'),
        ('connections.ems.username', '', 'string'),
        ('connections.ems.password', '', 'password'),
        ('connections.ems.clientId', '', 'string'),
        ...
        ('connections.jms.serverUrl', 'tcp://localhost:61613', 'string'),
        ('connections.jms.driverDirectory', '', 'string'),
        ('connections.jms.connectionFactoryClass', '', 'string'),
        ('connections.jms.connectionTimeoutSeconds', 30, 'integer'),
        ...
        ('connections.jms.clientId', '', 'string'),
        ...
        ('connections.pubsub.authenticationType', 'Service Account JSON', 'string'),
        ('connections.pubsub.serviceAccountJson', '', 'password'),
        ...
        ('connections.sap.outboundWorkerCount', 2, 'integer'),
        ('connections.sap.poolCapacity', 1, 'integer'),
        ('connections.sap.peakLimit', 1, 'integer'),
        ('connections.sap.connectionExpirationMilliseconds', 600000, 'integer'),
        ('connections.sap.outboundPoolIdleSeconds', 1800, 'integer'),
        ('connections.sap.maximumOutboundPools', 16, 'integer'),
