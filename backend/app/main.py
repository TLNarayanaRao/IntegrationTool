...
def python_source_files(project_payload: dict) -> dict[str, bytes]:
    ...
    header = '# Generated by Integration Fabric Studio. Changes are overwritten on export.\n\n'
    ...
    dsl = '''"""Small runtime DSL used by generated Integration Fabric Python applications."""
...
'''
    files: dict[str, bytes] = {
        'application/python/__init__.py': b'"""Generated Integration Fabric Python application."""\n',
        ...
        'application/python/README.md': b'''# Integration Fabric Python archive
...
readable source into the Integration Fabric runtime model at startup.
''',
    }
